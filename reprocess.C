...
void reprocess(string epoch="", string version_string="", string closure="") {
  ...
  if (epoch=="Run23C123") {
    ...
    fz = new TFile(Form("/work/mmalucch/L2L3Res_inputs/%s/zb/jme_bplusZ_merged_%s_2023Cv123.root", version, version),"READ"); // Summer23 L2Res_V1
  }
  if (epoch=="Run23C4") {
    ...
    fz = new TFile(Form("/work/mmalucch/L2L3Res_inputs/%s/zb/jme_bplusZ_merged_%s_2023Cv4.root", version, version),"READ"); // Summer23 L2Res_V1
  }
  if (epoch=="Run23D") {
